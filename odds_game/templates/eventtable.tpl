...
{{foreach $events as $event}}
	{{if $a==0 or $a!=substr($event->event_time,0,10)}} 
		...
		<ul id="eventid_{{$event->event_id}}" class="list-list bg1"> 
			...
			<li class="changc"><a href="{{$urlroot}}singleevent.php?eventid={{$event->event_id}}" class="eventicon" rel="singleeventmsg.php?eventid={{$event->event_id}}" ><img src="images/i-icon.png" /></a></li>
